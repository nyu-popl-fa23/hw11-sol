...
The deadline for Homework 11 is Friday, December 8, 8pm. The late submission deadline is Thursday, December 14, 4pm.
...
available at
`https://github.com/nyu-popl-fa23/hw11-<YOUR-GITHUB-USERNAME>`.
Note that this may take a few minutes.

* Open a browser at `https://github.com/nyu-popl-fa23/hw11-<YOUR-GITHUB-USERNAME>` with your Github username inserted at the appropriate place in the URL.
* Choose a place on your computer for your homework assignments to reside and open a terminal to that location.
* Execute the following git command: <br/>
  ```bash
  git clone https://github.com/nyu-popl-fa23/hw11-<YOUR-GITHUB-USERNAME>.git hw11
  cd hw11
  ```
